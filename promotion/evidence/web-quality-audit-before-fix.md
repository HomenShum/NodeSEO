...
Generated: 2026-08-14T02:23:48.336Z
...
| /pricing/ @ mobile-375: no horizontal overflow past the 375px device width | **FAIL** | scrollWidth=981 deviceWidth=375 layoutWidth=980 overflowing=[] |
| /pricing/ @ mobile-375: laid out at device width, not the 980px fallback | **FAIL** | layoutWidth=980 deviceWidth=375 meta=MISSING |
| /pricing/ @ mobile-375: every link is a tab stop with a visible focus ring | pass | links=0 tabReached=0 withRing=0 rings=[] |
| /faq/ @ mobile-375: no horizontal overflow past the 375px device width | **FAIL** | scrollWidth=981 deviceWidth=375 layoutWidth=980 overflowing=[] |
| /faq/ @ mobile-375: laid out at device width, not the 980px fallback | **FAIL** | layoutWidth=980 deviceWidth=375 meta=MISSING |
| /faq/ @ mobile-375: every link is a tab stop with a visible focus ring | pass | links=0 tabReached=0 withRing=0 rings=[] |
...
| /pricing/ @ desktop-1280: every link is a tab stop with a visible focus ring | pass | links=0 tabReached=0 withRing=0 rings=[] |
...
| /faq/ @ desktop-1280: every link is a tab stop with a visible focus ring | pass | links=0 tabReached=0 withRing=0 rings=[] |
...
|---|---|---:|---:|---:|---|---:|---|---:|---|---|---|
| / | mobile-375 | 375 | 375 | 375 | width=device-width, initial-scale=1 | 1 | 91x17 | 0 | **none** | **none** | **none** |
| /pricing/ | mobile-375 | 981 | 980 | 980 | **missing** | 0 | - | 0 | **none** | **none** | **none** |
| /faq/ | mobile-375 | 981 | 980 | 980 | **missing** | 0 | - | 0 | **none** | **none** | **none** |
| / | desktop-1280 | 1280 | 1280 | 1280 | width=device-width, initial-scale=1 | 1 | 91x17 | 0 | **none** | **none** | **none** |
| /pricing/ | desktop-1280 | 1280 | 1280 | 1280 | **missing** | 0 | - | 0 | **none** | **none** | **none** |
| /faq/ | desktop-1280 | 1280 | 1280 | 1280 | **missing** | 0 | - | 0 | **none** | **none** | **none** |
...
1. `body` (focus left the document) — outline `none`
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| / | mobile | 1 | 1 | 0.96 | 1 | 754ms | 0 | [`promotion/evidence/lighthouse/root-mobile.json`](lighthouse/root-mobile.json) |
| / | desktop | 1 | 1 | 0.96 | 1 | 204ms | 0 | [`promotion/evidence/lighthouse/root-desktop.json`](lighthouse/root-desktop.json) |
| /pricing/ | mobile | 1 | 1 | 0.96 | 1 | 753ms | 0 | [`promotion/evidence/lighthouse/pricing-mobile.json`](lighthouse/pricing-mobile.json) |
| /pricing/ | desktop | 1 | 1 | 0.96 | 1 | 203ms | 0 | [`promotion/evidence/lighthouse/pricing-desktop.json`](lighthouse/pricing-desktop.json) |
| /faq/ | mobile | 1 | 1 | 0.96 | 1 | 753ms | 0 | [`promotion/evidence/lighthouse/faq-mobile.json`](lighthouse/faq-mobile.json) |
| /faq/ | desktop | 1 | 1 | 0.96 | 1 | 203ms | 0 | [`promotion/evidence/lighthouse/faq-desktop.json`](lighthouse/faq-desktop.json) |

Failing audits, by run — every audit that did not score 1, including
zero-weight ones the category score hides:

- `/` mobile: errors-in-console (0)
- `/` desktop: errors-in-console (0)
- `/pricing/` mobile: errors-in-console (0), viewport-insight (0.5)
- `/pricing/` desktop: errors-in-console (0)
- `/faq/` mobile: errors-in-console (0), viewport-insight (0.5)
- `/faq/` desktop: errors-in-console (0)
...
| /pricing/ | 0 | none | 13 | [`promotion/evidence/axe/pricing.json`](axe/pricing.json) |
| /faq/ | 0 | none | 13 | [`promotion/evidence/axe/faq.json`](axe/faq.json) |
