...
Iteration 2 moved no condition — row 9 was already PASS — but it was resting on
a false sentence, so the score is unchanged and the evidence under it is not:
the second text filter is gone and a fixture now fails if it returns. Row 4
still has no committed overflow probe and stays UNVERIFIED. See
PROMOTION_LOG.md, "Correction — 2026-08-13", "Iteration 1 — 2026-08-13" and
